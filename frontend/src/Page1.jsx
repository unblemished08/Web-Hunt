...
//       {/* Main Section */}
//       <div className="w-full max-w-4xl flex flex-col sm:flex-row items-center justify-between bg-white p-6 rounded-lg shadow-md">
//         {/* Image on the Left */}
//         <div className="flex-shrink-0 mb-4 sm:mb-0 sm:mr-6">
//           <img
//             src="/copy.png"
//             alt="image1"
//             className="w-5/6 h-auto rounded-md shadow"
//           />
//         </div>
